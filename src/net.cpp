...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "IBTMaxcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"ibtmaxcointools.com", "mainnet.ibtmax.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"ibtmaxcointools.com", "testnet.ibtmax.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. IBTMaxcoin is probably already running."), addrBind.ToString().c_str());
        else
